...
const posts: Post[] = [
  ...
  {
    slug: 'simple-home-decor-with-handmade-items',
    title: 'Simple Home Décor with Handmade Items',
    excerpt: 'Warm up your space with baskets, wood, and clay — minimalist, affordable, and timeless.',
    image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1200&auto=format&fit=crop',
    content: `Start with a neutral base, then layer textures: a woven basket for storage, a wooden figurine, and a clay bowl center. Keep color tones earthy — clay, olive, and sand — to create calm.`
  }
];
